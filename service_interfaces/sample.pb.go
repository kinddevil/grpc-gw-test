...
func init() {
	...
	proto.RegisterType((*Reply)(nil), "services.Reply")
}
...
var fileDescriptor_2141552de9bf11d0 = []byte{
	...
	0xc8, 0x49, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x28, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c,
	0x4e, 0x2d, 0x96, 0x92, 0x49, 0xcf, 0xcf, 0x4f, 0xcf, 0x49, 0xd5, 0x4f, 0x2c, 0xc8, 0xd4, 0x4f,
	0xcc, 0xcb, 0xcb, 0x2f, 0x49, 0x2c, 0xc9, 0xcc, 0xcf, 0x2b, 0x86, 0xa8, 0x53, 0xd2, 0xe5, 0x62,
	...
	,
}
...
type SampleServiceClient interface {
	Sample(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error)
}
...
type SampleServiceServer interface {
	Sample(context.Context, *Request) (*Reply, error)
}
...
func (*UnimplementedSampleServiceServer) Sample(ctx context.Context, req *Request) (*Reply, error) {
...
func _SampleService_Sample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.SampleService/Sample",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).Sample(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

var _SampleService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "services.SampleService",
